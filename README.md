 ...
 **Enroll Pro可定制化的报名系统，适用于考试报名系统、活动报名系统、竞赛报名系统、岗位招聘报名系统等任何报名形式的场景，可用于生产、企业级别的项目。 项目和代码经过严格审核测试，支持私有化部署。** 
...
17. 审核结果通知，公告通知支持邮件、短信、微信公众号三种形式通知；
18. 系统支持 面试流程、笔试流程、笔试+面试流程三种模式;
19. 证书生成、证书颁发、证书查询真伪校验；
20. 报名表单支持动态拖拽形成报名表单和预定义报名表单两种形式，既能灵活配置报名表单项，又可定制化丰富样式。
